...
//PORT PIN ASSIGNMENTS    
    ...
    // result=TMR0L;
    TRISBbits.RB3 = 0;         // Make RA0 pin output (GREEN LED)
...
T0CONbits.TMR0ON = 0;
    ...
    if (result >= 0x19 && result <= 0x55)
{
    
             
      PORTBbits.RB3 = 1;       // Make RA0 high (GREEN LED ON)
      PORTBbits.RB1 = 0;       // Make RA0 high (RED LED OFF)
}
if (result >= 0x55)
{
          
       PORTBbits.RB3 = 0;       // Make RA0 high (GREEN LED OFF)
       PORTBbits.RB1 = 0;       // Make RA0 high (RED LED ON)
       PORTBbits.RB4 = 1;
